...
const Header = () => {
  ...
  return (
    <nav className="bg-primary-500 py-2 px-4 shadow fixed w-full z-10">
      <div
        className={`container flex flex-wrap items-center [&>*]:mr-5 ${
          !isCollapsed ? 'ml-64' : 'ml-24'
      ...
      >
        ...
        <span className="self-center text-2xl font-extrabold whitespace-nowrap text-neutral-100">
          Radya Digital CMS
        </span>
      </div>
    </nav>
